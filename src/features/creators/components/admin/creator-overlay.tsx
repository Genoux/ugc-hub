          ...
          {creator && (
            <div className="flex flex-1 min-h-0">
                  ...
                  <div className="border-t border-border pt-4 mb-4">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between gap-2">
                        ...
                        <Badge
                          variant="outline"
                          className={`text-[10px] ${ratingConfig.className}`}
                        >
              ...
              <div className="flex-1 min-w-0 p-6 overflow-y-auto pb-8">
                ...
                {/* Portfolio videos — uploaded by creator during onboarding */}
                <div className="mb-8">
                  <h2 className="text-base font-semibold text-foreground mb-4">
                    Past work
                    <span className="text-muted-foreground font-normal ml-2">
                      ({creator.portfolioVideos.length})
                    </span>
                  </h2>
                ...
                {/* Fieldtrip portfolio — admin-curated highlights across all collaborations */}
                <div className="mb-8">
                  <h2 className="text-base font-semibold text-foreground mb-4">
                    Fieldtrip portfolio
                    <span className="text-muted-foreground font-normal ml-2">
                  ...
                  {allHighlights.length > 0 ? (
                    ...
                    <p className="text-sm text-muted-foreground py-4">No highlights yet.</p>
                  )}
                </div>
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="border-t border-border px-6 py-4">
                              ...
                              {collab.highlights.length > 0 && (
                                <div className="mt-4">
                                  <p className="text-[10px] uppercase tracking-wider text-muted-foreground font-medium mb-2">
                                    Fieldtrip portfolio ({collab.highlights.length})
                                  </p>
                                  <div className="columns-2 gap-2 sm:columns-3 lg:columns-4">
                                    {collab.highlights.map((asset) => (
                                      <AssetCard
                                        key={asset.id}
                                        src={asset.url}
                                        filename={asset.filename}
                                        ...
                                        action={
                                          <Button
                                            ...
                                            onClick={async (e) => {
                                              e.stopPropagation();
                                              try {
                                                const blob = await fetch(asset.url).then((r) =>
                                                  r.blob(),
                                                );
                                                const blobUrl = URL.createObjectURL(blob);
                                                const a = document.createElement("a");
